...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('frontend_assets/css/feather.css') }}">


    <link rel="stylesheet" href="{{ asset('frontend_assets/plugins/apex/apexcharts.css') }}">
...
<body>
    ...
    <div class="main-wrapper">
                    ...
                    <ul class="main-nav  start">
                        ...
                        <li class="has-submenu active">
                            ...
                            <ul class="submenu">
                                ...
                                <li class="active"><a href="{{ route('profile.details', auth()->user()->id) }}">Profile Settings</a></li>
        ...
        @yield('contents')
                                    ...
                                    <div class="col-lg-3 col-md-6">
                                        ...
                                        <div class="footer-widget footer-menu">
                                            ...
                                            <ul>
                                                ...
                                                <li><a href="{{ route('patient.dashboard') }}"><i
                                                            class="fas fa-angle-double-right"></i>
                    ...
                    <script src="{{ asset('frontend_assets/plugins/apex/apexcharts.min.js') }}"></script>
                    <script src="{{ asset('frontend_assets//js/feather.min.js') }}"></script>
